...
# TccCode13_2_k1 com o plot em formato de comentário
# Variável armazena a coluna de D, e o código de comparação pega para plotar
#Isotropico com k = 0.485, e com tumor
# 2 significa sem tumor

#Colar o TccCode13_2_k1, do pacote CodeSTIsotrópico
...
ColunaTumorComp = 51
D_13_2_k1_RLine = D_13_2_k1[:, ColunaTumorComp]
