# TccCode13_2_FH com o plot em formato de comentário
# Variável armazena a coluna de D, e o código de comparação pega para plotar
#Horizontal com k = 0.485, e com tumor
# 2 significa com tumor
#Fibras na Horizontal usando o Diretório

#Colar o TccCode13_2_FH, do pacote CodeSTIsotrópico
...
plt.title('TccCode13_2_FH, Malha de '+ str(nr) + ' x ' + str(nz) + ' volumes', fontsize=20)
...
ColunaTumorComp = 51
D_13_2_FH_RLine = D_13_2_FH[:, ColunaTumorComp]
