# TccCode13_2_FV com o plot em formato de comentário
# Variável armazena a coluna de D, e o código de comparação pega para plotar
#Vertical com k = 0.485, e com tumor
# 2 significa com tumor

#Fibras na Vertical usando o Diretório

#Colar o TccCode13_2_FV, do pacote CodeSTIsotrópico
...
#Fibras na Vertical com k11 = 0.485, k22 = 0.53, e com tumor
# 2 significa com tumor
...
plt.title('TccCode13_2_FV, Malha de '+ str(nr) + ' x ' + str(nz) + ' volumes', fontsize=20)
...
ColunaTumorComp = 51
D_13_2_FV_RLine = D_13_2_FV[:, ColunaTumorComp]
