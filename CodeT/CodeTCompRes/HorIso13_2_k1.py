...
#Antes de rodar, verificar do Isotrópico K1 T, e Horizontal, e esse código:
#Tamanho de malha
...
#plt.title('HorIso13_2_k1, com '+ str(nr) + ' volumes paralelos em r', fontsize=20)
...
for i in range(len(eixox)):
    Diff_2_k1_k2.append(math.fabs((D_13_2_k1_RLine2[i] - D_13_2_FH_RLine2[i]))/ D_13_2_k1_RLine2[i] * 100)

PercDiff = Diff_2_k1_k2.copy()
plt.ylabel('Valores percentuais', fontsize=20)
plt.plot(eixox, PercDiff)
#plt.title('HorIso13_2_k1, , Malha de '+ str(nr) + ' volumes', fontsize=20)
