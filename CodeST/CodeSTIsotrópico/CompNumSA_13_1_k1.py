...
import seaborn
import CodeST.CodeSTIsotropico.TccCode13_SA_1_k1
import CodeST.CodeSTIsotropico.TccCode13_Num_1_k1
...
DSa3 = CodeST.CodeSTIsotropico.TccCode13_Num_1_k1.DSA
T4 = CodeST.CodeSTIsotropico.TccCode13_SA_1_k1.T3
D5 = []
...
#plt.title('CompNumSA_13_1_k1, , Malha de '+ str(nr) + ' volumes', fontsize=20)
