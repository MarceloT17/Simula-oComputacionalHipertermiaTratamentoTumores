...
ColunaTumorComp = 51
D_Mms_13_1_k1_RLine = D_Mms_13_1_k1[:, ColunaTumorComp]
#SolTmms13_1_k1
...
plt.plot(eixox, D_Mms_13_1_k1_RLine, marker='o', label='Solução pelo Mms')
plt.plot(eixox, A_1RLine, marker='^', label='Solução Manufaturada')
plt.ylabel('Valores sobrepostos', fontsize=25)
plt.xlabel("Eixo r [m]", fontsize=21)
#plt.title('VerScmms13_1_k1, , Malha de '+ str(nr) + ' volumes', fontsize=20)
...
for i in range(len(eixox)):
    Diff_SolScMms_13_1_k1.append(math.fabs((D_Mms_13_1_k1_RLine[i] - A_1RLine[i]))/ D_Mms_13_1_k1_RLine[i] * 100)
...
plt.plot(eixoD1, D1, label='Solução pelo Mms', fontsize=20)

#SolTmms12_1_k1
import CodeST.CodeSTIsotropico.solTmms13_1_k1
A_1 = CodeST.CodeSTIsotropico.solTmms13_1_k1.A_sol13.copy()
A_1_1 = numpy.reshape(A_1, ncolunas1)
plt.plot(eixoD1, A_1_1, label='Solução Manufaturada', fontsize=20)


#plt.title('VerScmms13_1_k1, Malha de '+ str(nr) + ' x ' + str(nz) + ' volumes, Matrizes Sobrepostas')
plt.ylabel("Valores sobrepostos", fontsize=20)
plt.xlabel('Eixo r [m]', fontsize=21)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.legend()
