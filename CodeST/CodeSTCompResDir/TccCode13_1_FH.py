...
# TccCode13_1_FH com o plot em formato de comentário
# Variável armazena a coluna de D, e o código de comparação pega para plotar
#Horizontal com k = 0.485, e sem tumor
# 1 significa sem tumor
#Fibras na Horizontal usando o Diretório

#Colar o TccCode13_1_FH, do pacote CodeSTFibrasHorizontal
...
ColunaTumorComp = 51
D_13_1_FH_RLine = D_13_1_FH[:, ColunaTumorComp]
