...
#Antes de rodar, verificar do Vertical ST, e Horizontal ST, e esse código:
#Tamanho de malha
...
for i in range(len(eixox)):
    Diff_1_k1_k2.append(math.fabs((D_13_1_FV_RLine2[i] - D_13_1_FH_RLine2[i]))/ D_13_1_FV_RLine2[i] * 100)
