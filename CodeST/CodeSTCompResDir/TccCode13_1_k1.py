# TccCode13_1_k1 com o plot em formato de comentário
...
#Colar o TccCode13_1_k1, do pacote CodeSTIsotrópico
...
plt.title('TccCode13_1_k1, Malha de '+ str(nr) + ' x ' + str(nz) + ' volumes, Fluxo de calor = ' + str(400) + ' Z = ' + str(Z) + ' Tempo em Horas =  ' + str(DifHour), fontsize=10)
...
ColunaTumorComp = 51
D_13_1_k1_RLine = D_13_1_k1[:, ColunaTumorComp]
