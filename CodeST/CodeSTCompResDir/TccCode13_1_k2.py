...
# TccCode13_1_k2 com o plot em formato de comentário
...
#Colar o TccCode13_1_k2, do pacote CodeSTIsotrópico
...
ax.invert_yaxis()
#title
plt.title('TccCode13_1_k2, Malha de '+ str(nr) + ' x ' + str(nz) + ' volumes, Fluxo de calor = ' + str(400) + ' Z = ' + str(Z) + ' Tempo em Horas =  ' + str(DifHour), fontsize=10)
#lablestitles
plt.xlabel("Eixo z [m]", fontsize=20)
plt.ylabel("Eixo r [m]", fontsize=20)
...
ColunaTumorComp = 51
D_13_1_k2_RLine = D_13_1_k2[:, ColunaTumorComp]
