...
#k11=0.485 para W e E, kw e ke
#k22=0.53 para S e N, ks e kn
...
ColunaTumorComp = 51
D_Mms_13_1_FV_RLine = D_Mms_13_1_FV[:, ColunaTumorComp]
#SolTmms13_1_k1
#pegando o solTmms do Isotrópico porque não consegue pegar o da pasta do vertical
...
plt.plot(eixox, D_Mms_13_1_FV_RLine, marker='o', label='Solução pelo Mms')
...
#plt.title('VerScmms13_1_FV, , Malha de '+ str(nr) + ' volumes', fontsize=20)
...
#estrutura para comparação, Tira uma linha paralela a r
#Importante atualizar o valor de ColunaTumorComp para ((nz/2) + 1)
# Usar o valor de D_Mms_13_1_FV_RLine na comparação
D_Mms_13_1_FV = D.copy()
#usando a coluna que tem o tumor. Neste código não tem tumor, mas para ficar no padrão dos que tem
# Valor de ColunaTumorComp = (nz/2) + 1
ColunaTumorComp = 51
...
Diff_SolScMms_13_1_FV = []
eixox = numpy.linspace(ra, R, nr)
for i in range(len(eixox)):
    Diff_SolScMms_13_1_FV.append(math.fabs((D_Mms_13_1_FV_RLine[i] - A_1RLine[i]))/ D_Mms_13_1_FV_RLine[i] * 100)

PercDiff = Diff_SolScMms_13_1_FV.copy()
...
#Usando o arquivo isotropico porque não muda em comparacao ao fibras na vertical
#SolTmms13_1_k1
import CodeST.CodeSTIsotropico.solTmms13_1_k1
A_1 = CodeST.CodeSTIsotropico.solTmms13_1_k1.A_sol13.copy()
...
plt.title('VerScmms13_1_FV, Malha de '+ str(nr) + ' x ' + str(nz) + ' volumes, Matrizes Sobrepostas')
plt.ylabel("Valores ")
plt.legend()
plt.show()
"""
